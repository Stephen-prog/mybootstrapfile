...
<nav class="navbar py-3 navbar-light navbar-expand-sm bg-primary">
    <!--logo-->
    <a href="#" class="navbar-brand text-uppercase font-italic">steve's website</a>
        ...
        <div class="row height align-items-center">
            <div class="col">
                ...
                <p class="text-muted lead py-2">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quos eligendi mollitia nesciunt natus omnis repudiandae voluptate dolor ducimus modi assumenda?
                </p>
                <a href="#" class="btn btn-outline-success btn-lg m-2 text-capitalize">press here</a>
                <a href="#" class="btn btn-outline-info btn-lg m-2 text-capitalize">press here</a>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 text-center my-4">
                ...
                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam aliquid officiis explicabo ipsa dolorum amet?</p>
            ...
            <div class="col-md-6 about-text height-80 px-5 d-flex align-items-center justify-content-center">
                ...
                <div class="about-text-center">
                    ...
                    <div class="checkbox-item d-flex">
                        ...
                        <p class="text-light lead ">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Distinctio, sed!</p>
                    </div>
                    <!--end of single item-->
                     <!--single item-->
                     <div class="checkbox-item d-flex">
...
<section id="project" class="py-5 bg-secondary">
    <div class="container">
        ...
        <div class="row py-3">
            <!--single project-->
            <div class="col-sm6 col-md-4 my-3">
                <img src="images/lightcoral.jpg" class="img-fluid rounded" alt="">
            </div>
            <!--end of single project-->
            <!--single project-->
            <div class="col-sm6 col-md-4 my-3">
                <img src="images/coral1.jpg" class="img-fluid img-thumbnail bg-info border border-info" alt="">
            </div>
            <!--end of single project-->
            <!--single project-->
            <div class="col-sm6 col-md-4 my-3 mx-auto">
                <img src="images/DSC_1168.jpeg" class="img-fluid rounded-circle" alt="">
            </div>
            <!--end of single project-->
        </div>
    </div>
    <div class="row py-3 no-gutters">
        <!--single project-->
        <div class="col-sm6 col-md-4 my-3">
            <img src="images/2019-audi-r8-onlocation.jpg" class="img-fluid" alt="project">
        </div>
        <!--end of single project-->
        <!--single project-->
        <div class="col-sm6 col-md-4 my-3">
            <img src="images/2019-lamborghini-urus.jpg" class="img-fluid" alt="project">
        </div>
        <!--end of single project-->
        <!--single project-->
        <div class="col-sm6 col-md-4 my-3 mx-auto">
            <img src="images/DSC_1168.jpeg" class="img-fluid" alt="project">
        </div>
        <!--end of single project-->
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 my-3">
                <div class="card">
                    <img src="images/2019-audi-r8-onlocation.jpg" alt="member" class="card-img-top">
                    <div class="card-body">
                        <div class="card-title text-capitalize">team member</div>
                        <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias, nam.</p>
            ...
            <!--end of team member-->
             ...
             <div class="col-md-6 col-lg-4 my-3">
                <div class="card">
                    <img src="images/Mercedes_Logo_10.jpg" alt="member" class="card-img-top">
                    <div class="card-body">
                        <div class="card-title text-capitalize">team member</div>
                        <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias, nam.</p>
                        <a href="#" class="btn btn-outline-warning text-uppercase">press here</a>
            ...
            <!--end of team member-->
             ...
             <div class="col-md-6 col-lg-4 my-3">
                <div class="card">
                    <img src="images/lightcoral.jpg" alt="member" class="card-img-top">
                    <div class="card-body">
                        <div class="card-title text-capitalize">team member</div>
                        <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias, nam.</p>
                        <a href="#" class="btn btn-outline-warning text-uppercase">press here</a>
            ...
            <!--end of team member-->
             ...
             <div class="col-md-6 col-lg-4 my-3">
                <div class="card">
                    <img src="images/2020-toyota-sequoia-spy-shots-1.jpg" alt="member" class="card-img-top">
                    <div class="card-body">
                        <div class="card-title text-capitalize">team member</div>
                        <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias, nam.</p>
                        <a href="#" class="btn btn-outline-warning text-uppercase">press here</a>
            ...
            <div class="col-md-6 col-lg-4 my-3">
                <div class="card">
                    <img src="images/2016-Mercedes-Benz-GLE-Coupe-2556.jpg" alt="member" class="card-img-top">
                    <div class="card-body">
                        <div class="card-title text-capitalize">team member</div>
                        <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias, nam.</p>
                        <a href="#" class="btn btn-outline-warning text-uppercase">press here</a>
            ...
            <div class="col-md-6 col-lg-4 my-3">
                <div class="card">
                    <img src="images/2020-Toyota-4Runner (1).jpg" alt="member" class="card-img-top">
                    <div class="card-body">
                        <div class="card-title text-capitalize">team member</div>
                        <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias, nam.</p>
                        <a href="#" class="btn btn-outline-warning text-uppercase">press here</a>
...
<section id="carousel" class="py-5 bg-primary">
  ...
  <div class="row">
      <div class="col-md-8 mx-auto text-center">
        <div id="exmple" class="carousel slide" data-ride='carousel'>
            <!--indicators-->
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="images/Rolls-Royce-Phantom-VIII-39-830x553.jpg" alt="project" class="d-block w-100">
                </div>
                <div class="carousel-item active">
                    <img src="images/maxresdefault-19.jpg" alt="project" class="d-block w-100">
                </div>
                <div class="carousel-item active">
                    <img src="images/Mercedes_Logo_10.jpg" alt="project" class="d-block w-100">
                </div>
                <div class="carousel-item active">
                    <img src="images/rolls-royce-phantom-viii-launch-1.jpg" alt="project" class="d-block w-100">
                </div>
            </div>
            <!--end of images-->
            <!--controls-->
...
<section id="filler" class="p-5">
    <div class="container">
        <div class="row">
            <div class="col-md-6 mx-auto text-pcenter">
                <h1 class="text-danger"> my first bootsrap website</h1>
                <p class="lead text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste ipsum similique nemo molestias esse officia, nam labore eum provident quaerat?</p>
                <a href="#" class="btn btn-large btn-primry m-2">press here</a>
            </div>
        </div>
    </div>
</section>
...
<section id="blog" class="p-5 bg-success">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="images/2019-audi-r8-onlocation.jpg" class="img-fluid img-thumbnail" alt="">
                <h2 class="my-3 text-warning">project 1</h2>
                <p class="text muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, ut.</p>
            </div>
            <div class="col-md-4 mt-3">
                <img src="images/DSC_1168.jpeg" class="img-fluid img-thumbnail" alt="">
                <h2 class="my-3 text-warning">project 2</h2>
                <p class="text muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, ut.</p>
            </div>
            <div class="col-md-4 mt-5">
                <img src="images/2019-lamborghini-urus.jpg" class="img-fluid img-thumbnail" alt="">
        ...
        <div class="row">
            ...
            <div class="col-md-6 my-3">
                <div class="embed-responsive embed-responsive-4by3">
                    <iframe class="embed-responsive-item" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d8069790.435797271!2d8.677457!3d9.0338725!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e745f4cd62fd9%3A0x53bd17b4a20ea12b!2sAbuja!5e0!3m2!1sen!2sng!4v1605182384882!5m2!1sen!2sng" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row">
        <div class="col-md-6 my-4">
            <img src="images/2019-audi-r8-onlocation.jpg" class="img-fluid rounded-circle d-none d-md-block" alt="">
        </div>
        <div class="col-md-6 my-4"></div>
        <blockquote class="blockquote text-right">
            <p><i class="fas fa-quote-left fa-2x mr-3"></i>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt tempora eum ratione sequi perferendis similique.  
            <i class="fas fa-quote-right fa-2x mr-3"></i></p>
            <footer class="blockquote-footer text-left">Rexsteroxxy</footer>
        </blockquote>
    </div>
  </div>  
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <!--progress bar single-->
                <h1 class="text-white text-capitalize">html</h1>
                <div class="progress bg-secondary">
                    <div class="progress-bar bg-success" style="width: 50%"></div>
                </div>
                <!--progress bar single-->
                <h1 class="text-white text-capitalize">css</h1>
                <div class="progress bg-secondary">
                    <div class="progress-bar bg-danger" style="width: 70%"></div>
                </div>
                <!--progress bar single-->
                <h1 class="text-white text-capitalize">js</h1>
                <div class="progress bg-secondary">
    ...
    <div class="modal-dialog">
        <div class="model-content">
            ...
            <div class="modal-header">
                <h3 class="modal-title text-white">are you sure you want to log-out?</h3>
